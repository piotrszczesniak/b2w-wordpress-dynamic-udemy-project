...
if (!function_exists('bootstrap2wordpress_setup')) :
	...
	function bootstrap2wordpress_setup()
	{
		...
		register_nav_menus(
			array(
				'top-menu' => esc_html__('Top Bar Menu', 'bootstrap2wordpress'),
...
function bootstrap2wordpress_widgets_init()
{
	register_sidebar(
		array(
			'name'          => esc_html__('Blog Sidebar', 'bootstrap2wordpress'),
			'id'            => 'sidebar-1',
...
function bootstrap2wordpress_scripts()
{
	...
	// Custom style
	wp_enqueue_style('custom-style', get_template_directory_uri() . '/sass/style.css', array(), false, 'all');

	// Slick slider - https://kenwheeler.github.io/slick/
	wp_enqueue_style('slickslider', 'href="//cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.css"');

	wp_enqueue_script('bootstrap2wordpress-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true);
	wp_enqueue_script('slickslider', 'href="//cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js"');
 ...
 * https://github.com/wp-bootstrap/wp-bootstrap-navwalker/blob/master/README.md
 */
